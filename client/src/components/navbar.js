        ...
        <nav className="z-10 sticky top-0 left-0 right-0 max-w-4xl xl:max-w-5xl mx-auto px-5 py-2.5 lg:border-none lg:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex lg:items-center gap-x-2">
              <button className="flex items-center text-black dark:text-white justify-center px-6 py-2.5 font-semibold hover:text-[#1A4870]">
          ...
          {isOpen && (
            <div className="lg:hidden mt-2">
              <ul className="flex flex-col space-y-2 text-base font-bold text-black/60 dark:text-white">
                ...
                <li className="pt-4">
                  <button className="block w-full text-left rounded-md bg-[#F5EDED] text-black px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                    <Link href="/register">Sign up</Link>
                  </button>
                </li>
                <li>
